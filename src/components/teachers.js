    ...
    <div className="flex justify-center items-center flex-wrap-reverse ">
      <Frame>
        <div className="flex justify-center flex-wrap mb-s2">
          <div className="bg-angelina w-avatar h-avatar sm:w-avatarD sm:h-avatarD bg-no-repeat bg-contain my-s03 mx-s1 " />
        ...
        <span>
          ...
          Удивительно, правда?
          <br /> Но я понимала, что этот язык - везде. Сейчас вот эра pop-it'ов
          и simple dimple. А еще телефоны и компьютеры выдают ошибки на
          английском. <br />
          Собрав волю в кулак, я продолжила заниматься. Моя борьба с английским
          только спустя время переросла в интересную дружбу с ним. <br />
          Позже у меня появилась возможность учить испанский с преподавателем из
          Мадрида. И каким счастьем было узнать, что там нет стольких правил
          чтения, как в английском!
          <br /> Ну, а потом, сложилось так, что своими знаниями я начала
          делиться с другими, теми - у кого возникало желание получить новые
          знания.
          <br /> И вот так преподавание языков стало делом, которое я люблю
        </span>
      </Frame>
      <Frame>
        <div className="flex justify-center flex-wrap mb-s2">
        ...
        <span>
          ...
          языки.
          <br /> Язык дал мне возможность путешествовать и мои поездки позволяют
          мне познавать его изнутри, общаясь с народами, использующими различные
          диалектны в самых отдаленных уголках мира. <br />
          Моя любовь к английскому настолько сильна, что когда-то мое увлечение
          переросло в дело моей жизни. На моих занятиях я с радостью поделюсь с
          тобой накопленным опытом и знаниями.
        </span>
      </Frame>
      <Frame>
        <div className="flex justify-center flex-wrap mb-s2">
        ...
        <span>
          ...
          <br />
          Сегодня я хочу делиться с тобой своими знаниями и навыками, показать,
